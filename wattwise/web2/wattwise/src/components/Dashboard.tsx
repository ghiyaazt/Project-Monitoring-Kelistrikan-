...
import { realtimeData, realtimeChart, anomaliList } from "../data/mockData";
      ...
      <div className="dashboard-grid-1-lg-3">
        ...
        <div className="dashboard-chart-container">
          ...
          <div className="dashboard-device-row">
            {connectedDevices.slice(0, 4).map((device, idx) => {
              const colors = ["#16a34a", "#2563eb", "#7c3aed", "#f59e0b"];
              const color = colors[idx % colors.length];
              const maxDaya = Math.max(...connectedDevices.map(d => d.daya || 0));
              return (
