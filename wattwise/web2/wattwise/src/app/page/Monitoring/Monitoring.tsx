...
import { IoTDevice, AnomalyEvent, realtimeData, realtimeChart, anomaliList, detailAnomali, riwayatHarian, riwayatStats } from "../../../data/mockData";
...
export default function Monitoring() {
  ...
  const filteredAnomali = anomaliList.filter((a: AnomalyEvent) => anomaliFilter === "semua" || a.status === anomaliFilter);
  const totalBaru = anomaliList.filter((a: AnomalyEvent) => a.status === "baru").length;
            ...
            <div className="monitoring-anomali-layout">
              ...
              <div className="monitoring-anomali-list-col">
                ...
                <div className="monitoring-anomali-list">
                  {filteredAnomali.map((a: AnomalyEvent) => (
                ...
                {selectedAnomali ? (
                  <>
                    <div className="monitoring-anomali-detail-fields">
                      {(() => {
                        const selected = anomaliList.find((a: AnomalyEvent) => a.id === selectedAnomali);
                        return [
            ...
            <div className="monitoring-riwayat-table-card">
              ...
              <div className="monitoring-riwayat-table-wrapper">
                <table className="monitoring-riwayat-table">
                  ...
                  <tbody>
                    {riwayatHarian.map((r: any, i: number) => (
                      <tr key={i}>
    ...
    <div className="monitoring-list-view-container">
      ...
      <div className="monitoring-list-stats-grid">
        ...
        <div className="monitoring-list-stat-card monitoring-list-stat-card-connected">
          ...
          <p className="monitoring-list-stat-value monitoring-list-stat-value-green">{devices.filter((d: IoTDevice) => d.status === "connected").length}</p>
          <p className="monitoring-list-stat-sub">Online</p>
        </div>
        <div className="monitoring-list-stat-card">
          <p className="monitoring-list-stat-label">Terputus</p>
          <p className="monitoring-list-stat-value monitoring-list-stat-value-amber">{devices.filter((d: IoTDevice) => d.status === "disconnected").length}</p>
          <p className="monitoring-list-stat-sub">Offline</p>
        </div>
        <div className="monitoring-list-stat-card">
          <p className="monitoring-list-stat-label">Error</p>
          <p className="monitoring-list-stat-value monitoring-list-stat-value-red">{devices.filter((d: IoTDevice) => d.status === "error").length}</p>
