    ...
    <div className="auth-container">
        ...
        <div className="auth-brand-content">
          <div>
            <h2 className="auth-brand-heading">
              Monitoring listrik <br />berbasis IoT
            </h2>
          ...
          <div className="auth-feature-list">
            {[
              ...
              { icon: "🔔", label: "Notifikasi Anomali", sub: "Terima alert saat ada lonjakan listrik tidak wajar" },
      ...
      <div className="auth-form-panel">
        <div className="auth-form-container">
          ...
          <p className="auth-subtitle">Masuk untuk memantau konsumsi listrik Anda</p>
